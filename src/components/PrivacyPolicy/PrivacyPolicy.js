  ...
  return (
    <div className={classes}>
      ...
      <p>Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen
        besonders hohen Stellenwert für die Geschäftsleitung der Let's Bake GbR. Eine Nutzung der
        Internetseiten der Let's Bake GbR ist grundsätzlich ohne jede Angabe personenbezogener Daten
      ...
      <p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift,
        ...
        der Datenschutz-Grundverordnung und in Übereinstimmung mit den für die Let's Bake GbR
      ...
      <p>Die Let's Bake GbR hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
      ...
      <p>Die Datenschutzerklärung der Let's Bake GbR beruht auf den Begrifflichkeiten, die durch den
      ...
      <p>Deutschland</p>
      <p>Tel.: 01728753834</p>
      <p>E-Mail: info@letsbake.de</p>
      <p>Website: letsbake.de</p>
      ...
      <p>Deutschland</p>
      <p>Tel.: 01728753834</p>
      <p>E-Mail: julemariehaverkamp@gmail.com</p>
      <p>Website: letsbake.de</p>

      <p>Jede betroffene Person kann sich jederzeit bei allen Fragen und Anregungen zum Datenschutz
        direkt an unseren Datenschutzbeauftragten wenden.</p>

      <h4>4. Cookies</h4>
      <p>Die Internetseiten der Let's Bake GbR verwenden Cookies. Cookies sind Textdateien, welche
      ...
      <p>Durch den Einsatz von Cookies kann die Let's Bake GbR den Nutzern dieser Internetseite
      ...
      <p>Die Internetseite der Let's Bake GbR erfasst mit jedem Aufruf der Internetseite durch eine
      ...
      <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Let's Bake GbR keine
        ...
        anonym erhobenen Daten und Informationen werden durch die Let's Bake GbR daher einerseits
      ...
      <p>Auf der Internetseite der Let's Bake GbR wird den Benutzern die Möglichkeit eingeräumt, den
        ...
        ergibt sich aus der hierzu verwendeten Eingabemaske.</p>

      <p>Die Let's Bake GbR informiert ihre Kunden und Geschäftspartner in regelmäßigen Abständen im
        ...
        betroffene Person über eine gültige E-Mail-Adresse verfügt und (2) die betroffene Person
        sich für den Newsletterversand registriert. An die von einer betroffenen Person erstmalig
        für den Newsletterversand eingetragene E-Mail-Adresse wird aus rechtlichen Gründen eine
      ...
      <p>Bei der Anmeldung zum Newsletter speichern wir ferner die vom Internet-Service-Provider
      ...
      <p>Die im Rahmen einer Anmeldung zum Newsletter erhobenen personenbezogenen Daten werden
        ...
        Newsletters kann durch die betroffene Person jederzeit gekündigt werden. Die Einwilligung in
        ...
        der Einwilligung findet sich in jedem Newsletter ein entsprechender Link. Ferner besteht die
        Möglichkeit, sich jederzeit auch direkt auf der Internetseite des für die Verarbeitung
      ...
      <p>Die Newsletter der Let's Bake GbR enthalten sogenannte Zählpixel. Ein Zählpixel ist eine
        ...
        durchgeführt werden. Anhand des eingebetteten Zählpixels kann die Let's Bake GbR erkennen,
      ...
      <p>Solche über die in den Newslettern enthaltenen Zählpixel erhobenen personenbezogenen Daten,
        ...
        Newsletterversand zu optimieren und den Inhalt zukünftiger Newsletter noch besser den
        Interessen der betroffenen Person anzupassen. Diese personenbezogenen Daten werden nicht an
        Dritte weitergegeben. Betroffene Personen sind jederzeit berechtigt, die diesbezügliche
        ...
        Let's Bake GbR automatisch als Widerruf.</p>

      <h4>9. Kontaktmöglichkeit über die Internetseite</h4>
      <p>Die Internetseite der Let's Bake GbR enthält aufgrund von gesetzlichen Vorschriften
      ...
      <p>Die im Blog der Let's Bake GbR abgegebenen Kommentare können grundsätzlich von Dritten
        abonniert werden. Insbesondere besteht die Möglichkeit, dass ein Kommentator die seinem
        Kommentar nachfolgenden Kommentare zu einem bestimmten Blog-Beitrag abonniert.</p>

      <p>Sofern sich eine betroffene Person für die Option entscheidet, Kommentare zu abonnieren,
        versendet der für die Verarbeitung Verantwortliche eine automatische Bestätigungsmail, um im
        Double-Opt-In-Verfahren zu überprüfen, ob sich wirklich der Inhaber der angegebenen
        E-Mail-Adresse für diese Option entschieden hat. Die Option zum Abonnement von Kommentaren
        kann jederzeit beendet werden.</p>
      ...
      <ul>
        ...
        <li><h4>b) Recht auf Auskunft</h4>
          <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
            ...
            über folgende Informationen zugestanden:</p>
        ...
        <li>
          ...
          <ul >
            ...
            <li>Die betroffene Person widerruft ihre Einwilligung, auf die sich die Verarbeitung
              gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO stützte,
          ...
          <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung
            von personenbezogenen Daten, die bei der Let's Bake GbR gespeichert sind, veranlassen
            möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Let's Bake GbR wird veranlassen, dass dem
            Löschverlangen unverzüglich nachgekommen wird.</p>

          <p>Wurden die personenbezogenen Daten von der Let's Bake GbR öffentlich gemacht und ist
            unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
            personenbezogenen Daten verpflichtet, so trifft die Let's Bake GbR unter
            ...
            Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Let's Bake GbR wird im
        ...
        <li><h4>e) Recht auf Einschränkung der Verarbeitung</h4>
          ...
          <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person
            die Einschränkung von personenbezogenen Daten, die bei der Let's Bake GbR gespeichert
            sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Let's Bake GbR wird die
        ...
        <li><h4>f) Recht auf Datenübertragbarkeit</h4>
          ...
          <p>Ferner hat die betroffene Person bei der Ausübung ihres Rechts auf Datenübertragbarkeit
            ...
            anderer Personen beeinträchtigt werden.</p>

          <p>Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person
            jederzeit an einen Mitarbeiter der Let's Bake GbR wenden.</p>
        ...
        <li>
          ...
          <p>Die Let's Bake GbR verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
          ...
          <p>Verarbeitet die Let's Bake GbR personenbezogene Daten, um Direktwerbung zu betreiben,
            ...
            betroffene Person gegenüber der Let's Bake GbR der Verarbeitung für Zwecke der
            Direktwerbung, so wird die Let's Bake GbR die personenbezogenen Daten nicht mehr für
          ...
          <p>Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen
            ...
            bei der Let's Bake GbR zu wissenschaftlichen oder historischen Forschungszwecken oder zu
          ...
          <p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden
            Mitarbeiter der Let's Bake GbR oder einen anderen Mitarbeiter wenden. Der betroffenen
        ...
        <li><h4>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h4>
          ...
          <p>Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen
            ...
            ausdrücklicher Einwilligung der betroffenen Person, trifft die Let's Bake GbR
        ...
        <li><h4>i) Recht auf Widerruf einer datenschutzrechtlichen Einwilligung</h4>
          ...
          <p>Möchte die betroffene Person ihr Recht auf Widerruf einer Einwilligung geltend machen,
            kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden.</p>

        </li>
      </ul>
      <h4>13. Datenschutzbestimmungen zu Einsatz und Verwendung von Adobe Analytics (Omniture) /
        Adobe Marketing Cloud</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten des
        ...
        (nachfolgend „Omniture“ genannt) ist ein Instrument, das ein effizienteres Online-Marketing
        sowie eine Web-Analyse ermöglicht. Omniture ist ein Teil der Adobe Marketing Cloud. Die
        Adobe Marketing Cloud ermöglicht Echtzeitanalysen von Besucherströmen auf Internetseiten.
        Die Echtzeitanalysen umfassen Projektberichte und gestatten eine Ad-Hoc-Analyse der
        Internetseitenbesucher. Kundeninteraktionen werden so dargestellt, dass dem für die
        Verarbeitung Verantwortlichen ein besserer Überblick über die Onlineaktivitäten der Nutzer
        dieser Internetseite verschafft wird, indem die Daten in einfachen und interaktiven
        Dashboards angezeigt und in Berichte umgewandelt werden. Dies versetzt den für die
        Verarbeitung Verantwortlichen in die Lage, Informationen in Echtzeit zu erhalten und
        hierdurch auftretende Probleme schneller zu erkennen.</p>

      <p>Betreibergesellschaft dieser Services ist die Adobe Systems Software Ireland Limited, 4-6
        Riverwalk, Citywest Business Campus, Dublin 24, Ireland.</p>

      <p>Omniture setzt ein Cookie auf dem informationstechnologischen System der betroffenen Person
        (Cookies wurden im Vorfeld bereits erklärt; entsprechendes kann oben nachgelesen werden).
        Der für die Verarbeitung Verantwortliche gewährleistet durch eine Servereinstellung, dass
        die an das Datencenter von Adobe übermittelten Tracking-Datensätze vor einer
        Geolokalisierung anonymisiert werden. Die Anonymisierung wird durch das Ersetzen des letzten
        Teils der IP-Adresse umgesetzt. Der für die Verarbeitung Verantwortliche hat serverseitig
        Einstellungen vorgenommen, aufgrund derer die IP-Adresse der betroffenen Person vor einer
        jeweiligen Verarbeitung für die Geolokalisierung und die Reichweitenmessung unabhängig
        voneinander anonymisiert werden. Adobe wird im Auftrag des für die Verarbeitung
        Verantwortlichen die über unsere Internetseite gewonnenen Daten und Informationen dazu
        nutzen das Nutzerverhalten der betroffenen Person auszuwerten. Ferner wird Adobe die Daten
        nutzen, um in unserem Auftrag Reports über die Nutzeraktivitäten zu erstellen sowie weitere
        Dienstleistungen für unser Unternehmen zu erbringen, die im Zusammenhang mit der Nutzung
        unserer Internetseite stehen. Die IP-Adresse der betroffenen Person wird durch Adobe nicht
        mit anderen personenbezogenen Daten zusammengeführt.</p>
      ...
      <p>Die betroffene Person kann die Setzung von Cookies durch unsere Internetseite, wie oben
        ...
        solche Einstellung des genutzten Internetbrowsers würde auch verhindern, dass Omniture ein
        Cookie auf dem informationstechnologischen System der betroffenen Person setzt. Zudem können
        die von Omniture bereits gesetzten Cookies jederzeit über einen Internetbrowser oder andere
        Softwareprogramme gelöscht werden.</p>

      <p>Ferner besteht für die betroffene Person die Möglichkeit, einer Erfassung der durch das
        Adobe-Cookie erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der
        Verarbeitung dieser Daten durch Adobe zu widersprechen und eine solche zu verhindern. Hierzu
        muss die betroffene Person den Abmelde-Button unter dem Link
        http://www.adobe.com/de/privacy/opt-out.html drücken, der einen Opt-Out-Cookie setzt. Der
        mit dem Widerspruch gesetzte Opt-Out-Cookie wird auf dem von der betroffenen Person
        genutzten informationstechnologischen System abgelegt. Werden die Cookies auf dem System der
        betroffenen Person nach einem Widerspruch gelöscht, muss die betroffene Person den Link
        erneut aufrufen und einen neuen Opt-Out-Cookie setzen.</p>

      <p>Mit der Setzung des Opt-Out-Cookies besteht jedoch die Möglichkeit, dass die Internetseiten
        des für die Verarbeitung Verantwortlichen für die betroffene Person nicht mehr
        vollumfänglich nutzbar sind.</p>

      <p>Die geltenden Datenschutzbestimmungen von Adobe können unter
        http://www.adobe.com/de/privacy.html abgerufen werden.</p>
      ...
      <p>Ein soziales Netzwerk ist ein im Internet betriebener sozialer Treffpunkt, eine
        ...
        privaten Profilen, den Upload von Fotos und eine Vernetzung über Freundschaftsanfragen.</p>

      <p>Betreibergesellschaft von Facebook ist die Facebook, Inc., 1 Hacker Way, Menlo Park, CA
        ...
        Canal Square, Grand Canal Harbour, Dublin 2, Ireland.</p>
      ...
      <p>Facebook erhält über die Facebook-Komponente immer dann eine Information darüber, dass die
        ...
        des Aufrufs unserer Internetseite gleichzeitig bei Facebook eingeloggt ist; dies findet
        unabhängig davon statt, ob die betroffene Person die Facebook-Komponente anklickt oder
        nicht. Ist eine derartige Übermittlung dieser Informationen an Facebook von der betroffenen
      ...
      <p>Die von Facebook veröffentlichte Datenrichtlinie, die unter
        ...
        betroffene Person genutzt werden, um eine Datenübermittlung an Facebook zu unterdrücken.</p>

      <h4>15. Datenschutzbestimmungen zu Einsatz und Verwendung von Google AdSense</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Google AdSense
        integriert. Google AdSense ist ein Online-Dienst, über welchen eine Vermittlung von Werbung
        auf Drittseiten ermöglicht wird. Google AdSense beruht auf einem Algorithmus, welcher die
        auf Drittseiten angezeigten Werbeanzeigen passend zu den Inhalten der jeweiligen Drittseite
        auswählt. Google AdSense gestattet ein interessenbezogenes Targeting des Internetnutzers,
        welches mittels Generierung von individuellen Benutzerprofilen umgesetzt wird.</p>

      <p>Betreibergesellschaft der Google-AdSense-Komponente ist die Google Ireland Limited, Gordon
        House, Barrow Street, Dublin, D04 E5W5, Ireland.</p>

      <p>Der Zweck der Google-AdSense-Komponente ist die Einbindung von Werbeanzeigen auf unserer
        Internetseite. Google-AdSense setzt ein Cookie auf dem informationstechnologischen System
        der betroffenen Person. Was Cookies sind, wurde oben bereits erläutert. Mit der Setzung des
        Cookies wird der Alphabet Inc. eine Analyse der Benutzung unserer Internetseite ermöglicht.
        Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die
        Verarbeitung Verantwortlichen betrieben wird und auf welcher eine Google-AdSense-Komponente
        integriert wurde, wird der Internetbrowser auf dem informationstechnologischen System der
        betroffenen Person automatisch durch die jeweilige Google-AdSense-Komponente veranlasst,
        Daten zum Zwecke der Online-Werbung und der Abrechnung von Provisionen an die Alphabet Inc.
        zu übermitteln. Im Rahmen dieses technischen Verfahrens erhält die Alphabet Inc. Kenntnis
        über personenbezogene Daten, wie der IP-Adresse der betroffenen Person, die der Alphabet
        Inc. unter anderem dazu dienen, die Herkunft der Besucher und Klicks nachzuvollziehen und in
        der Folge Provisionsabrechnungen zu ermöglichen.</p>

      <p>Die betroffene Person kann die Setzung von Cookies durch unsere Internetseite, wie oben
        bereits dargestellt, jederzeit mittels einer entsprechenden Einstellung des genutzten
        Internetbrowsers verhindern und damit der Setzung von Cookies dauerhaft widersprechen. Eine
        solche Einstellung des genutzten Internetbrowsers würde auch verhindern, dass die Alphabet
        Inc. ein Cookie auf dem informationstechnologischen System der betroffenen Person setzt.
        Zudem kann ein von der Alphabet Inc. bereits gesetzter Cookie jederzeit über den
        Internetbrowser oder andere Softwareprogramme gelöscht werden.</p>

      <p>Google AdSense verwendet zudem sogenannte Zählpixel. Ein Zählpixel ist eine Miniaturgrafik,
        die in Internetseiten eingebettet wird, um eine Logdatei-Aufzeichnung und eine
        Logdatei-Analyse zu ermöglichen, wodurch eine statistische Auswertung durchgeführt werden
        kann. Anhand des eingebetteten Zählpixels kann die Alphabet Inc. erkennen, ob und wann eine
        Internetseite von einer betroffenen Person geöffnet wurde und welche Links von der
        betroffenen Person angeklickt wurden. Zählpixel dienen unter anderem dazu, den Besucherfluss
        einer Internetseite auszuwerten.</p>

      <p>Über Google AdSense werden personenbezogene Daten und Informationen, was auch die
        IP-Adresse umfasst und zur Erfassung und Abrechnung der angezeigten Werbeanzeigen notwendig
        ist, an die Alphabet Inc. in die Vereinigten Staaten von Amerika übertragen. Diese
        personenbezogenen Daten werden in den Vereinigten Staaten von Amerika gespeichert und
        verarbeitet. Die Alphabet Inc. gibt diese über das technische Verfahren erhobenen
        personenbezogenen Daten unter Umständen an Dritte weiter.</p>

      <p>Google-AdSense wird unter diesem Link https://www.google.de/intl/de/adsense/start/ genauer
        erläutert.</p>

      <h4>16. Datenschutzbestimmungen zu Einsatz und Verwendung von Google Analytics (mit
      ...
      <p>Betreibergesellschaft der Google-Analytics-Komponente ist die Google Ireland Limited,
        Gordon House, Barrow Street, Dublin, D04 E5W5, Ireland.</p>
      ...
      <p>Google Analytics setzt ein Cookie auf dem informationstechnologischen System der
        ...
        Zwecke der Online-Analyse an Google zu übermitteln. Im Rahmen dieses technischen Verfahrens
        erhält Google Kenntnis über personenbezogene Daten, wie der IP-Adresse der betroffenen
        Person, die Google unter anderem dazu dienen, die Herkunft der Besucher und Klicks
      ...
      <h4>17. Datenschutzbestimmungen zu Einsatz und Verwendung von Google Remarketing</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Dienste von Google
        Remarketing integriert. Google Remarketing ist eine Funktion von Google-AdWords, die es
        einem Unternehmen ermöglicht, bei solchen Internetnutzern Werbung einblenden zu lassen, die
        sich zuvor auf der Internetseite des Unternehmens aufgehalten haben. Die Integration von
      ...
      <p>Betreibergesellschaft der Dienste von Google Remarketing ist die Google Ireland Limited,
        Gordon House, Barrow Street, Dublin, D04 E5W5, Ireland.</p>

      <p>Zweck von Google Remarketing ist die Einblendung von interessenrelevanter Werbung. Google
      ...
      <p>Google Remarketing setzt ein Cookie auf dem informationstechnologischen System der
        betroffenen Person. Was Cookies sind, wurde oben bereits erläutert. Mit der Setzung des
        Cookies wird Google eine Wiedererkennung des Besuchers unserer Internetseite ermöglicht,
        wenn dieser in der Folge Internetseiten aufruft, die ebenfalls Mitglied des
        Google-Werbenetzwerks sind. Mit jedem Aufruf einer Internetseite, auf welcher der Dienst von
        Google Remarketing integriert wurde, identifiziert sich der Internetbrowser der betroffenen
        Person automatisch bei Google. Im Rahmen dieses technischen Verfahrens erhält Google
        Kenntnis über personenbezogene Daten, wie der IP-Adresse oder des Surfverhaltens des
        Nutzers, welche Google unter anderem zur Einblendung interessenrelevanter Werbung
        verwendet.</p>

      <p>Mittels des Cookies werden personenbezogene Informationen, beispielsweise die durch die
        betroffene Person besuchten Internetseiten, gespeichert. Bei jedem Besuch unserer
        Internetseiten werden demnach personenbezogene Daten, einschließlich der IP-Adresse des von
        der betroffenen Person genutzten Internetanschlusses, an Google in den Vereinigten Staaten
        von Amerika übertragen. Diese personenbezogenen Daten werden durch Google in den Vereinigten
        Staaten von Amerika gespeichert. Google gibt diese über das technische Verfahren erhobenen
        personenbezogenen Daten unter Umständen an Dritte weiter.</p>
      ...
      <p>Ferner besteht für die betroffene Person die Möglichkeit, der interessenbezogenen Werbung
        ...
        gewünschten Einstellungen vornehmen.</p>
      ...
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Google AdWords
        ...
        Google-Werbenetzwerk zu schalten. Google AdWords ermöglicht es einem Werbetreibenden, vorab
        ...
        der Suchmaschine ein schlüsselwortrelevantes Suchergebnis abruft. Im Google-Werbenetzwerk
      ...
      <p>Betreibergesellschaft der Dienste von Google AdWords ist die Google Ireland Limited, Gordon
        House, Barrow Street, Dublin, D04 E5W5, Ireland.</p>

      <p>Der Zweck von Google AdWords ist die Bewerbung unserer Internetseite durch die Einblendung
      ...
      <p>Gelangt eine betroffene Person über eine Google-Anzeige auf unsere Internetseite, wird auf
        dem informationstechnologischen System der betroffenen Person durch Google ein sogenannter
        ...
        Warenkorb von einem Online-Shop-System, auf unserer Internetseite aufgerufen wurden. Durch
        den Conversion-Cookie können sowohl wir als auch Google nachvollziehen, ob eine betroffene
        Person, die über eine AdWords-Anzeige auf unsere Internetseite gelangt ist, einen Umsatz
        generierte, also einen Warenkauf vollzogen oder abgebrochen hat.</p>

      <p>Die durch die Nutzung des Conversion-Cookies erhobenen Daten und Informationen werden von
        ...
        identifiziert werden könnte.</p>

      <p>Mittels des Conversion-Cookies werden personenbezogene Informationen, beispielsweise die
      ...
      <p>Die betroffene Person kann die Setzung von Cookies durch unsere Internetseite, wie oben
        bereits dargestellt, jederzeit mittels einer entsprechenden Einstellung des genutzten
        Internetbrowsers verhindern und damit der Setzung von Cookies dauerhaft widersprechen. Eine
        solche Einstellung des genutzten Internetbrowsers würde auch verhindern, dass Google einen
        Conversion-Cookie auf dem informationstechnologischen System der betroffenen Person setzt.
        Zudem kann ein von Google AdWords bereits gesetzter Cookie jederzeit über den
        Internetbrowser oder andere Softwareprogramme gelöscht werden.</p>
      ...
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten des
        ...
        Weiterverbreitung solcher Daten in anderen sozialen Netzwerken ermöglicht.</p>

      <p>Betreibergesellschaft der Dienste von Instagram ist die Facebook Ireland Ltd., 4 Grand
        Canal Square, Grand Canal Harbour, Dublin 2 Ireland.</p>
      ...
      <p>Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die
        ...
        informationstechnologischen System der betroffenen Person automatisch durch die jeweilige
        Instagram-Komponente veranlasst, eine Darstellung der entsprechenden Komponente von
      ...
      <p>Sofern die betroffene Person gleichzeitig bei Instagram eingeloggt ist, erkennt Instagram
        mit jedem Aufruf unserer Internetseite durch die betroffene Person und während der gesamten
      ...
      <p>Instagram erhält über die Instagram-Komponente immer dann eine Information darüber, dass
        die betroffene Person unsere Internetseite besucht hat, wenn die betroffene Person zum
        Zeitpunkt des Aufrufs unserer Internetseite gleichzeitig bei Instagram eingeloggt ist; dies
        findet unabhängig davon statt, ob die betroffene Person die Instagram-Komponente anklickt
        oder nicht. Ist eine derartige Übermittlung dieser Informationen an Instagram von der
        betroffenen Person nicht gewollt, kann diese die Übermittlung dadurch verhindern, dass sie
        sich vor einem Aufruf unserer Internetseite aus ihrem Instagram-Account ausloggt.</p>
      ...
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von
        Twitter integriert. Twitter ist ein multilingualer öffentlich zugänglicher
        Mikroblogging-Dienst, auf welchem die Nutzer sogenannte Tweets, also Kurznachrichten, die
        auf 280 Zeichen begrenzt sind, veröffentlichen und verbreiten können. Diese Kurznachrichten
        sind für jedermann, also auch für nicht bei Twitter angemeldete Personen abrufbar. Die
        Tweets werden aber auch den sogenannten Followern des jeweiligen Nutzers angezeigt. Follower
        sind andere Twitter-Nutzer, die den Tweets eines Nutzers folgen. Ferner ermöglicht Twitter
        über Hashtags, Verlinkungen oder Retweets die Ansprache eines breiten Publikums.</p>

      <p>Betreibergesellschaft von Twitter International Company, One Cumberland Place, Fenian
        Street Dublin 2, D02 AX07, Ireland.</p>
      ...
      <p>Sofern die betroffene Person gleichzeitig bei Twitter eingeloggt ist, erkennt Twitter mit
        jedem Aufruf unserer Internetseite durch die betroffene Person und während der gesamten
        Dauer des jeweiligen Aufenthaltes auf unserer Internetseite, welche konkrete Unterseite
        unserer Internetseite die betroffene Person besucht. Diese Informationen werden durch die
        Twitter-Komponente gesammelt und durch Twitter dem jeweiligen Twitter-Account der
        betroffenen Person zugeordnet. Betätigt die betroffene Person einen der auf unserer
        Internetseite integrierten Twitter-Buttons, werden die damit übertragenen Daten und
        Informationen dem persönlichen Twitter-Benutzerkonto der betroffenen Person zugeordnet und
        von Twitter gespeichert und verarbeitet.</p>

      <p>Twitter erhält über die Twitter-Komponente immer dann eine Information darüber, dass die
        betroffene Person unsere Internetseite besucht hat, wenn die betroffene Person zum Zeitpunkt
        des Aufrufs unserer Internetseite gleichzeitig bei Twitter eingeloggt ist; dies findet
        unabhängig davon statt, ob die betroffene Person die Twitter-Komponente anklickt oder nicht.
        Ist eine derartige Übermittlung dieser Informationen an Twitter von der betroffenen Person
        nicht gewollt, kann diese die Übermittlung dadurch verhindern, dass sie sich vor einem
        Aufruf unserer Internetseite aus ihrem Twitter-Account ausloggt.</p>

      <p>Die geltenden Datenschutzbestimmungen von Twitter sind unter
        https://twitter.com/privacy?lang=de abrufbar.</p>

      <h4>21. Zahlungsart: Datenschutzbestimmungen zu PayPal als Zahlungsart</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von
        PayPal integriert. PayPal ist ein Online-Zahlungsdienstleister. Zahlungen werden über
        sogenannte PayPal-Konten abgewickelt, die virtuelle Privat- oder Geschäftskonten darstellen.
        Zudem besteht bei PayPal die Möglichkeit, virtuelle Zahlungen über Kreditkarten abzuwickeln,
        wenn ein Nutzer kein PayPal-Konto unterhält. Ein PayPal-Konto wird über eine E-Mail-Adresse
        geführt, weshalb es keine klassische Kontonummer gibt. PayPal ermöglicht es,
        Online-Zahlungen an Dritte auszulösen oder auch Zahlungen zu empfangen. PayPal übernimmt
        ferner Treuhänderfunktionen und bietet Käuferschutzdienste an.</p>

      <p>Die Europäische Betreibergesellschaft von PayPal ist die PayPal (Europe) S.à.r.l. et Cie,
        S.C.A., 22-24 Boulevard Royal L-2449, Luxemburg.</p>

      <p>Wählt die betroffene Person während des Bestellvorgangs in unserem Online-Shop als
        ...
        die zur Zahlungsabwicklung erforderliche Übermittlung personenbezogener Daten ein.</p>

      <p>Bei den an PayPal übermittelten personenbezogenen Daten handelt es sich in der Regel um
        ...
        der jeweiligen Bestellung stehen.</p>

      <p>Die Übermittlung der Daten bezweckt die Zahlungsabwicklung und die Betrugsprävention. Der
        für die Verarbeitung Verantwortliche wird PayPal personenbezogene Daten insbesondere dann
        übermitteln, wenn ein berechtigtes Interesse für die Übermittlung gegeben ist. Die zwischen
        PayPal und dem für die Verarbeitung Verantwortlichen ausgetauschten personenbezogenen Daten
        werden von PayPal unter Umständen an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung
        bezweckt die Identitäts- und Bonitätsprüfung.</p>

      <p>PayPal gibt die personenbezogenen Daten gegebenenfalls an verbundene Unternehmen und
        Leistungserbringer oder Subunternehmer weiter, soweit dies zur Erfüllung der vertraglichen
        Verpflichtungen erforderlich ist oder die Daten im Auftrag verarbeitet werden sollen.</p>

      <p>Die betroffene Person hat die Möglichkeit, die Einwilligung zum Umgang mit
        personenbezogenen Daten jederzeit gegenüber PayPal zu widerrufen. Ein Widerruf wirkt sich
        nicht auf personenbezogene Daten aus, die zwingend zur (vertragsgemäßen) Zahlungsabwicklung
        verarbeitet, genutzt oder übermittelt werden müssen. </p>
      ...
      <h4>22. Zahlungsart: Datenschutzbestimmungen zu Skrill als Zahlungsart</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von
        Skrill integriert. Skrill ist ein Online-Zahlungsdienstleister. Die Zahlungen werden über
        das sogenannte Skrill-Wallet abgewickelt, welches eine virtuelle elektronische Geldbörse
        darstellt. Skrill bietet auch die Möglichkeit, virtuelle Zahlungen über Kreditkarten
        abzuwickeln. Ein Skrill-Wallet wird über eine E-Mail-Adresse geführt. Skrill ermöglicht es,
        Online-Zahlungen an Dritte auszulösen oder Zahlungen zu empfangen.</p>

      <p>Betreibergesellschaft von Skrill ist die Skrill Limited, 25 Canada Square, London E14 5LQ,
        United Kingdom.</p>

      <p>Wählt die betroffene Person während des Bestellvorgangs in unserem Online-Shop als
        Zahlungsmöglichkeit „Skrill“ aus, werden automatisiert Daten der betroffenen Person an
        Skrill übermittelt. Mit der Auswahl dieser Zahlungsoption willigt die betroffene Person in
        die zur Zahlungsabwicklung erforderliche Übermittlung personenbezogener Daten ein.</p>

      <p>Bei den mit Skrill ausgetauschten personenbezogenen Daten handelt es sich um die Kaufsumme
        und die E-Mail-Adresse, die zur Zahlungsabwicklung notwendig sind. Die Übermittlung der
        Daten bezweckt die Zahlungsabwicklung und die Betrugsprävention. Der für die Verarbeitung
        ...
        Umständen an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung bezweckt die
        Identitäts- und Bonitätsprüfung.</p>

      <p>Skrill gibt die personenbezogenen Daten gegebenenfalls an verbundene Unternehmen und
        Leistungserbringer oder Subunternehmer weiter, soweit dies zur Erfüllung der vertraglichen
        Verpflichtungen erforderlich ist oder die Daten im Auftrag verarbeitet werden sollen.</p>

      <p>Die betroffene Person hat die Möglichkeit, die Einwilligung zum Umgang mit
        personenbezogenen Daten jederzeit gegenüber Skrill zu widerrufen. Ein Widerruf wirkt sich
        nicht auf personenbezogene Daten aus, die zwingend zur (vertragsgemäßen) Zahlungsabwicklung
        verarbeitet, genutzt oder übermittelt werden müssen. </p>

      <p>Die geltenden Datenschutzbestimmungen von Skrill können unter
        https://www.skrill.com/de/fusszeile/datenschutzbestimmungen/ abgerufen werden.</p>

      <h4>23. Zahlungsart: Datenschutzbestimmungen zu Sofortüberweisung als Zahlungsart</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von
        Sofortüberweisung integriert. Sofortüberweisung ist ein Zahlungsdienst, der eine bargeldlose
        Zahlung von Produkten und Dienstleistungen im Internet ermöglicht. Sofortüberweisung bildet
        ein technisches Verfahren ab, durch welches der Online-Händler unverzüglich eine
        Zahlungsbestätigung erhält. So wird ein Händler in die Lage versetzt, Waren,
        Dienstleistungen oder Downloads sofort nach der Bestellung an den Kunden auszuliefern.</p>

      <p>Betreibergesellschaft von Sofortüberweisung ist die Klarna Bank AB, Sveavägen 46, 111 34
        Stockholm, Schweden.</p>

      <p>Wählt die betroffene Person während des Bestellvorgangs in unserem Online-Shop als
        Zahlungsmöglichkeit „Sofortüberweisung“ aus, werden automatisiert Daten der betroffenen
        Person an Sofortüberweisung übermittelt. Mit einer Auswahl dieser Zahlungsoption willigt die
        betroffene Person in eine zur Zahlungsabwicklung erforderliche Übermittlung
        personenbezogener Daten ein.</p>

      <p>Bei der Kaufabwicklung über Sofortüberweisung übermittelt der Käufer die PIN und die TAN an
        die Sofort GmbH. Sofortüberweisung führt sodann nach technischer Überprüfung des
        Kontostandes und Abruf weiterer Daten zur Prüfung der Kontodeckung eine Überweisung an den
        Online-Händler aus. Die Durchführung der Finanztransaktion wird dem Online-Händler sodann
        automatisiert mitgeteilt.</p>

      <p>Bei den mit Sofortüberweisung ausgetauschten personenbezogenen Daten handelt es sich um
        Vorname, Nachname, Adresse, Email-Adresse, IP-Adresse, Telefonnummer, Mobiltelefonnummer
      ...
      <p>Sofortüberweisung gibt die personenbezogenen Daten gegebenenfalls an verbundene Unternehmen
      ...
      <p>Die betroffene Person hat die Möglichkeit, die Einwilligung zum Umgang mit
        personenbezogenen Daten jederzeit gegenüber Sofortüberweisung zu widerrufen. Ein Widerruf
        wirkt sich nicht auf personenbezogene Daten aus, die zwingend zur (vertragsgemäßen)
        Zahlungsabwicklung verarbeitet, genutzt oder übermittelt werden müssen.</p>

      <p>Die geltenden Datenschutzbestimmungen von Sofortüberweisung können unter
        https://www.klarna.com/sofort/datenschutz/ abgerufen werden.</p>

      <h4>24. Rechtsgrundlage der Verarbeitung</h4>
      ...
      <h4>25. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder einem
      ...
      <h4>26. Dauer, für die die personenbezogenen Daten gespeichert werden</h4>
      ...
      <h4>27. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen
      ...
      <h4>28. Bestehen einer automatisierten Entscheidungsfindung</h4>
      ...
      <p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche
        Gesellschaft für Datenschutz GmbH, die als <a
          ...
          Datenschutzbeauftragter Dachau</a> tätig ist, in Kooperation mit dem <a
          href="https://www.wbs-law.de/it-recht/datenschutzrecht/">Anwalt für
